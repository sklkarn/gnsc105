...
},
{
  ...
  "body": " Several people deserve credit for their generous help with this book. I wish to thank my colleagues and students for the contributions they have made to improve this book through questionnaires and classroom discussion.  "
},
{
...
},
{
  "id": "table-1",
  "level": "2",
  "url": "sec_first-obs.html#table-1",
  "type": "Table",
  "number": "1.2.2",
...
},
{
  "id": "example-1",
  "level": "2",
  "url": "sec_first-obs.html#example-1",
  "type": "Example",
  "number": "1.2.3",
  "title": "",
...
},
{
  "id": "example-2",
  "level": "2",
  "url": "sec_first-obs.html#example-2",
  "type": "Example",
  "number": "1.2.4",
  "title": "",
...
},
{
  ...
  "number": "1.4.4",
  "title": "",
  "body": " Find the area of a piece of land in correct significant figures which has 21 m width and 247 m length.   empty  "
},
{
  "id": "exercise-5",
  "level": "2",
...
},
{
  ...
  "body": " Introduction to Motion   Motion can be described in terms of distance, displacement, position, time, speed, velocity, and acceleration. Motion is an act of movement. There are verieties of types of motion we come accross in physics. They are linear motion, circular motion, periodic motion, harmonic motion, vibration motion, uniform motion, non-uniform motion, etc. To understand the motion, we need to learn types of physical quantities.  We have already been introduced about physical quantity in . Here we are going to learn little more about physical quantity. As we know anything that can be measured in numbers and units are a physical quantity. Physical quantities are of two types in general, namely scalar physical quantity (or scalars) and vector physical quantity (or vectors). Scalars has magnitude only and no direction is involved in this physical quantity. For example: distance, speed, mass, time, density, temperature, currency, work, energy, current, power, pressure, etc. Vectors has both magnitude and direction. For example: displacement, velocity, acceleration, force, weight, momentum, torque, etc. Vector quantity is represented by an arrow pointing along its direction and size of the arrow represent its magnitude. In figure below is a vector OP which is pointing along its direction and size of arrow is representing the magnitude of that vector. Actually, it is not logical to scale the vectors everytime we draw them on the paper, hence we distinguish the vectors just by their magnitude value and direction but not by the size of the drawing.  Vector Representation        Some useful terminologies of motion    Distance:  Displacement:  Speed:  Velocity:  Acceleration:    More content.    Another Subsection  Text with some math: only for some values of .    After the last subsection, you might have a conclusion.   "
},
{
  "id": "figure-2",
  "level": "2",
...
},
{
  "id": "example-6",
  "level": "2",
  "url": "sec_second-examples.html#example-6",
  "type": "Example",
  "number": "2.2.1",
  "title": "",
...
{
  "id": "thm_second-examples-theorem",
  "level": "2",
  "url": "sec_second-examples.html#thm_second-examples-theorem",
  "type": "Theorem",
  "number": "2.2.3",
  "title": "Theorem Title.",
...
{
  "id": "cor_second-examples-corollary",
  "level": "2",
  "url": "sec_second-examples.html#cor_second-examples-corollary",
  "type": "Corollary",
  "number": "2.2.4",
  "title": "",
...
},
{
  ...
  "type": "Section",
  "number": "3.1",
  "title": "Introduction to Third Chapter",
  "body": " Introduction to Third Chapter   Intro to section, because we will have subsections.  Another paragraph of the introduction.    A subsection  Content of the subsection.  More content.    Another Subsection  Text with some math: only for some values of .    After the last subsection, you might have a conclusion.   "
},
{
...
},
{
  "id": "example-8",
  "level": "2",
  "url": "sec_third-examples.html#example-8",
  "type": "Example",
  "number": "3.2.1",
  "title": "",
  "body": "  The statement of the example, since it will have a solution. What is the solution?    This is the solution.   "
},
{
  "id": "example-9",
  "level": "2",
  "url": "sec_third-examples.html#example-9",
  "type": "Example",
  "number": "3.2.2",
  "title": "",
  "body": " This is an example of an example without a solution (or hint or answer) so the paragraph doesn't need to be inside a statement tag.  "
...
{
  "id": "thm_third-examples-theorem",
  "level": "2",
  "url": "sec_third-examples.html#thm_third-examples-theorem",
  "type": "Theorem",
  "number": "3.2.3",
  "title": "Theorem Title.",
  "body": " Theorem Title   This is the statement of the theorem.    And this is its proof.   "
...
{
  "id": "cor_third-examples-corollary",
  "level": "2",
  "url": "sec_third-examples.html#cor_third-examples-corollary",
  "type": "Corollary",
  "number": "3.2.4",
  "title": "",
  "body": "  A corollary that doesn't need a proof.   "
...
{
  "id": "remark_third-examples-context",
  "level": "2",
  "url": "sec_third-examples.html#remark_third-examples-context",
  "type": "Remark",
  "number": "3.2.5",
  "title": "Larger Context.",
  "body": " Larger Context  Comment to the reader here.  "
...
},
{
  ...
  "number": "8",
  "title": "Perodic Table",
  "body": " Perodic Table   Try adding your own content here!   "
},
{
  "id": "ch_ninth",
  "level": "1",
  ...
  "type": "Chapter",
  "number": "9",
  "title": "Crystals and Solution",
  "body": " Crystals and Solution   Try adding your own content here!   "
},
{
  "id": "ch_tenth",
  "level": "1",
...
},
{
  ...
  "body": " Atmosphere and Hydrosphere   Try adding your own content here!   "
},
{
  "id": "ch_twelvth",
  "level": "1",
...
},
{
  ...
  "number": "13",
  "title": "Solar System",
  "body": " Solar System   Try adding your own content here!   "
},
{
  "id": "ch_fourteenth",
  "level": "1",
...
},
{
  "id": "example-10",
  "level": "2",
  "url": "sec_features-blocks.html#example-10",
  "type": "Example",
  "number": "16.1.2",
  "title": "",
...
},
{
  "id": "figure-3",
  "level": "2",
  "url": "sec_features-blocks.html#figure-3",
  "type": "Figure",
  "number": "16.1.3",
  "title": "",
